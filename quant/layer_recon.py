...
def layer_reconstruction(model: QuantModel, layer: QuantModule, cali_data: torch.Tensor,
    ...
    if layer.weight_quantizer.lwc:
        opt_params_w = [layer.weight_quantizer.alpha, layer.weight_quantizer.upbound_factor, layer.weight_quantizer.lowbound_factor]
        # layer.weight_quantizer.lwc_train = True
    else:
